...
- [ ] Task 11 not yet started — the final on-device build/deploy/validate task. Ready to start: SSH access is set up, the pen device path is confirmed, and all code tasks (0–10) are complete and reviewed.
